...
const Footer = () => {
  ...
  return (
    <footer className="text-white relative bg-[url('https://res.cloudinary.com/dxohwanal/image/upload/v1759037067/c2e2f213e1e503847422279b40868bb4_lp1rah.jpg')] bg-cover bg-center">
