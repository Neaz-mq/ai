            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="space-y-1">
                  ...
                  <input type="text" name="name" className="w-full bg-transparent border-b border-green-400 focus:border-indigo-400 py-2 text-white" />
                </div>
                <div className="space-y-1">
                  <label className="text-sm text-gray-300">Email *</label>
                  <input type="email" name="email" className="w-full bg-transparent border-b border-green-400 focus:border-indigo-400 py-2 text-white" />
                </div>
              </div>

              <div className="space-y-1">
                <label className="text-sm text-gray-300">Subject *</label>
                <input type="text" name="subject" className="w-full bg-transparent border-b border-green-400 focus:border-indigo-400 py-2 text-white" />
              </div>

              <div className="space-y-1">
                <label className="text-sm text-gray-300">Comments / Questions *</label>
                <textarea name="message" rows="4" className="w-full bg-transparent border-b border-green-400 focus:border-indigo-400 py-2 text-white resize-none" />
              </div>

              <button type="submit" className="w-full px-6 py-3 text-lg font-semibold rounded-xl bg-green-600 hover:bg-green-700 transition cursor-pointer">
                Send Message
              </button>
            </form>
          </motion.div>
